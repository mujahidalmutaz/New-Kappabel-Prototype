    ...
    <div className='min-h-screen bg-gray-50'>
      <div className={`bg-gradient-to-r ${COLOR} text-white px-8 py-6`}>
        ...
        <div className='grid grid-cols-3 gap-4 mt-4'>
          {[['Total', stats.total, 'bg-white/20'], ['Draft', stats.draft, 'bg-gray-400/30'], ['Applied', stats.applied, 'bg-green-400/30']].map(([l, v, c]) => (
            ...
            <div className='overflow-y-auto flex-1 px-6 py-5 space-y-5'>
              ...
              {form.employeeId && !isView && !isApplied && (
                <div className='bg-red-50 border border-red-200 rounded-xl p-4'>
                  <p className='text-sm font-semibold text-red-700'>{t('⚠️ Peringatan Terminasi','⚠️ Termination Warning')}</p>
            ...
            <div className='flex items-center justify-between px-6 py-4 border-t bg-gray-50 flex-shrink-0'>
              ...
              {!isView && !isApplied && (
                <div className='flex gap-2'>
                  ...
                  <button onClick={() => handleSave('Applied')} className='px-4 py-2 text-sm font-semibold text-white bg-red-600 rounded-xl hover:bg-red-700 shadow'>Apply — Terminate</button>
                </div>
              )}
