...
export default function LearningProfilePage() {
  ...
  const handleSave = () => {
    flash('Profil learning berhasil diperbarui.')
    setEditMode(false)
  }

  const STATS = [
    { label:'Course Selesai', value:16, icon:'🎓', color:'#7c3aed' },
    { label:'CPD Points', value:'420', icon:'⭐', color:'#d97706' },
    { label:'Sertifikat', value:3, icon:'🏆', color:'#059669' },
  ...
  return (
    <div>
      ...
      <p className='text-gray-500 text-sm mb-6'>Ringkasan dan preferensi pembelajaran Anda.</p>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-6'>
        ...
        <div>
          <div className='bg-white rounded-xl p-6 shadow-sm text-center mb-4'>
            ...
            <button onClick={()=>setEditMode(!editMode)}
              ...
              {editMode ? 'Batal Edit' : '✏️ Edit Profil'}
            </button>
          </div>

          <div className='bg-white rounded-xl p-5 shadow-sm'>
            <h3 className='font-semibold text-gray-700 mb-3 text-sm'>🎯 Minat Belajar</h3>
        ...
        <div className='lg:col-span-2 space-y-4'>
          ...
          <div className='bg-white rounded-xl p-6 shadow-sm'>
            <h3 className='font-semibold text-gray-700 mb-4'>📋 Preferensi Belajar</h3>
            {editMode ? (
              <div className='space-y-4'>
                ...
                <div className='grid grid-cols-2 gap-4'>
                  {[['Gaya Belajar Foreref','preferredStyle',['Self-Paced','ILT / Instructor-Led','Blended','Video-First']],
                    ['Waktu Favorit','preferredTime',['Pagi (07:00-09:00)','Siang (12:00-14:00)','Sore (17:00-19:00)','Malam (20:00-22:00)']],
                    ['Bahasa Konten','preferredLang',['Indonesia','English','Bilingual']]].map(([l,k,opts])=>(
                    <div key={k}>
              ...
              <div className='space-y-3'>
                {[
                  ...
                  ['Gaya Belajar', profile.preferredStyle],
                  ['Waktu Favorit', profile.preferredTime],
                  ['Bahasa Konten', profile.preferredLang],
                  ['Email', profile.email],
